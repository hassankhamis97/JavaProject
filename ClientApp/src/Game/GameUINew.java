...
public class GameUINew extends BorderPane {
    ...
    protected final Button btnChat;
    protected final ImageView chatBtn;
    ...
    protected final ImageView imageBtn1;
    protected final ImageView imageBtn2;
    protected final ImageView imageBtn3;
    protected final ImageView imageBtn4;
    protected final ImageView imageBtn5;
    protected final ImageView imageBtn6;
    protected final ImageView imageBtn7;
    protected final ImageView imageBtn8;
    protected final ImageView imageBtn9;
    ...
    protected final TextField chatMsg_txt;
    protected final Button btnEmoji;
    protected final ImageView btnImojiImg;
    protected final Button send_btn;
    protected final ScrollPane scrollPane;
    protected final AnchorPane chatAnch;
    protected final ImageView chatOpponentImg;
    protected final Label label;
    protected final FlowPane imojiMenu;
    protected final ImageView imageView0;
    protected final ImageView imageView1;
    protected final ImageView imageView2;
    protected final AnchorPane anchorPane4;
    protected final ImageView player1_Img;
    protected final ImageView imageView3;
    protected final Label coinScoreLbl;
    protected final ImageView player2_Img;
    protected final Label player1Score;
    protected final Label player2Score;
    protected final MenuButton btnMenue;
    ...
    public GameUINew() {
        ...
        AnchorPane.setBottomAnchor(chatNotificationTxt, 23.5);
        AnchorPane.setRightAnchor(chatNotificationTxt, 306.0);
        AnchorPane.setTopAnchor(chatNotificationTxt, 45.5);
        ...
        label.setText("fvnsdbvjklmfvnjk");
